                        ...
                        <div class="row">
                            <div class="col-md-6 offset-md-3">
                                ...
                                <div class="p-2">
                                    ...
                                    <form action="{{ route('teacher.payment.setup.process') }}" method="post">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="_institute" id="_institute" class="form-control">
                                                ...
                                                @foreach ($institutes as $institute)
                                                    <option value="{{ $institute->id }}" {{ old('_institute') == $institute->id ? 'selected' : '' }}>{{ $institute->name }}
                                        ...
                                        <div class="form-group">
                                            <label for="per_student">Per Student Payment <span
                                                        class="text-danger">*</span></label>
                                            <input type="number" name="per_student_payment" id="per_student"
                                                   class="form-control">
