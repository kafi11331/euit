...
@section('title', 'Mentor Payment Setup Edit - European IT Solutions Institute')
            ...
            <div class="col-md-10 col-lg-12">
                <div class="card">
                    ...
                    <span class="float-left">
                        <h4>Mentor Payment Setup Edit</h4>
                    </span>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 offset-md-3">
                                ...
                                <form action="{{ route('mentor.payment-setup.update') }}" method="post">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <select name="course" id="course" class="form-control">
                                                ...
                                                @foreach ($mpi->mentor->courses as $course)
                                                    <option value="{{ $course->id }}" {{ $mpi->course_id == $course->id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <select name="batch" id="batch" data-selected="{{ $mpi->batch_id }}" class="form-control"></select>
                                            @if ($errors->has('batch'))
                                        ...
                                        <div class="col-md-9">
                                            <select name="year" id="year" class="form-control">
                                                @foreach (range((date('Y') + 1), 2017) as $date)
                                                    <option value="{{ $date }}" {{ $date == $mpi->year ? 'selected' : '' }}>
                                                        {{ $date }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="number" name="total_class" value="{{ $mpi->total_class }}" id="total_class" class="form-control">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-inline">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="per_class" name="payment"
                                                           value="per_class" {{ $mpi->per_class_payment > 0 ? 'checked' : '' }}
                                                ...
                                                <div class="custom-control custom-radio ml-3">
                                                    <input type="radio" id="batch_wise" name="payment"
                                                           value="batch_wise" {{ $mpi->batch_wise_payment > 0 ? 'checked' : '' }}
                                                           class="custom-control-input">
                                            ...
                                            <div class="">
                                                <input type="number" name="per_class_amount" value="{{$mpi->per_class_payment }}"
                                                       id="per_class_payment"
                                                       placeholder="Per class amount" style="display: none"
                                                       class="form-control mt-2">
                                                <input type="number" name="batch_wise_amount" value="{{ $mpi->batch_wise_payment }}"
...
@push('js')
    <script type="text/javascript">
        ...
        function batchesByCourse() {
            if ('' !== $(this).val()) {
                $.ajax({
                    url: ("{{ route('course.batches', 'cid') }}").replace('cid', $(this).val()),
                    method: "GET",
                    success: function (response) {
                        if ('' !== response) {
                            let output = '<option value="" hidden>Choose...</option>';
                            let batch = $('#batch');
                            batch.html(output + response);
